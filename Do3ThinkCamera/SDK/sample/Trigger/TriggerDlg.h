...
#include "../../../library/Visual C++/include/dvpParam.h"
#include <string>
#include "afxcmn.h"
...
protected:
	...
	int m_TriggerDelay;
	dvpIntDescr m_DelayDescr;
	dvpDoubleDescr m_FilterDescr;
	bool m_bTriggerMode;
...
public:
	...
	CComboBox m_LineSelector;
	CComboBox m_LineMode;
	CComboBox m_LineSource;
	afx_msg void OnBnClickedCheckLineInverter();
	afx_msg void OnSelchangeComboLineSelector();
	afx_msg void OnSelchangeComboLineMode();
	afx_msg void OnSelchangeComboLineSource();
};
